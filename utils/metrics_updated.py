...
print("surface dice at 1mm:      {}".format(
    compute_surface_dice_at_tolerance(surface_distances, 1)))
print("volumetric dice:          {}".format(
    compute_dice_coefficient(mask_gt, mask_pred)))
...
surface_distances = compute_surface_distances(
    mask_gt, mask_pred, spacing_mm=(3, 2, 1))
print("average surface distance: {} mm".format(
    compute_average_surface_distance(surface_distances)))
print("hausdorff (100%):         {} mm".format(
    compute_robust_hausdorff(surface_distances, 100)))
print("hausdorff (95%):          {} mm".format(
    compute_robust_hausdorff(surface_distances, 95)))
